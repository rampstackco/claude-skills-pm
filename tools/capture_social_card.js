...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .badge.discovery { background: rgba(30, 64, 175, 0.25); color: #93c5fd; }
  .badge.planning { background: rgba(124, 58, 237, 0.25); color: #c4b5fd; }
  .badge.execution { background: rgba(234, 88, 12, 0.25); color: #fdba74; }
  .badge.launch { background: rgba(220, 38, 38, 0.25); color: #fca5a5; }
  .badge.measure { background: rgba(5, 150, 105, 0.25); color: #6ee7b7; }
...
<body>
  <div class="card">
    <h1>Claude Skills PM</h1>
    <p class="tagline">12 product management skills for Claude Code</p>
    <div class="badges">
      <span class="badge discovery">Discovery &middot; 2</span>
      <span class="badge planning">Planning &middot; 3</span>
      <span class="badge execution">Execution &middot; 3</span>
      <span class="badge launch">Launch &middot; 2</span>
      <span class="badge measure">Measure &middot; 2</span>
    </div>
