#!/usr/bin/env python3
"""
Lint script for the Claude Skills PM catalog.
...
12-skill PM subset rather than the full catalog:
- check_cross_skill_references: skills here legitimately reference the
  other ~87 skills that live only in the full claude-skills catalog.
- check_readme_catalog_generated: this repo has a hand-written README,
  not one produced by a generator script.

The brand watchlist is not stored in this repo. It is fetched by CI
from the private rampstack/lint-config repo; see load_brand_watchlist
below.
